...
hi LineNr   term=underline ctermfg=darkred guifg=ivory4 guibg=gray4
...
" syntax hi colors
hi Comment  term=bold ctermfg=darkmagenta guifg=cyan4
hi PreProc  term=underline ctermfg=blue guifg=dodgerblue4
hi Constant term=underline ctermfg=green guifg=firebrick3
hi Type     term=underline ctermfg=yellow gui=none guifg=chartreuse3
hi Statement    term=bold ctermfg=blue gui=none guifg=gold3
hi Identifier   term=underline ctermfg=darkgreen guifg=darkolivegreen4
hi Ignore   term=bold ctermfg=darkgray guifg=gray45
hi Special  term=underline ctermfg=darkred guifg=sienna
